...
public enum Errors {
    ...
    INVALID_BOOLEAN_OPERANDS ("Non-boolean operands to boolean operator at line {0}, column {1}"),
    COMPARISON_OPERAND_DISAGREEMENT ("Operands to comparison operator are not comparable at line {0}, column {1}");
